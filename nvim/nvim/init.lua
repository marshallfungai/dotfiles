...
require('lazy').setup({
  ...
  --  To import all plugins once Uncomment the following line - `lua/marshallfungai/plugins/*.lua`
  --  { import = 'marshallfungai.plugins' },
  -- Note: No need to import the plugins below, they are already imported in the `marshallfungai.plugins` module

  -- require 'kickstart.plugins.debug',
  require 'marshallfungai.plugins.toggleterm', -- Terminal
  require 'marshallfungai.plugins.lsp-config', -- LSP Configurations
  ...
  require 'marshallfungai.plugins.codium',
  require 'marshallfungai.plugins.flash',
  require 'marshallfungai.plugins.comment',
  -- require 'marshallfungai.plugins.none-ls',
}, {
  ui = {
